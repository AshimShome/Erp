            ...
            if (count($products)>0)
            {
                ...
                foreach ($products as $key => $product)
                {
                    ...
                    if(!empty($product->pro_image)){
                        $image_url =('storage/uploads/pro_image').'/'.$product->pro_image;
                    }else{
                        $image_url =('storage/uploads/pro_image').'/default.png';
                    }
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4 col-12">
                                <div class="tab-pane fade show active toacart w-100" data-url="' . url('add-to-cart/' . $product->id . '/' . $lastsegment) .'">
                                    <div class="position-relative card">
                                        <img alt="Image placeholder" src="' . asset('/') . $image_url . '" class="card-image avatar shadow hover-shadow-lg" style=" height: 6rem; width: 100%;">
                ...
                if ($originalquantity < $cart[$id]['quantity'] && $session_key == 'pos') {
                    return response()->json(
                        [
                            'code' => 404,
                            'status' => 'Error',
                            'info' => __('This product is out of stock!'),
                        ],
                        404
                    );
                }
