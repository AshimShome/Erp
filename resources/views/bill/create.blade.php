...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'bill','class'=>'w-100','enctype' => 'multipart/form-data')) }}
        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{Form::date('due_date',null,array('class'=>'form-control', 'required'=>'required' , 'min'=>\Carbon\Carbon::today()->format('Y-m-d')) )}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
