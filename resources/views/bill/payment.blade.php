{{ Form::open(array('route' => array('bill.payment', $bill->id),'method'=>'post','enctype' => 'multipart/form-data')) }}
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                {{ Form::label('id', __('Category'),['class'=>'form-label']) }}
            ...
            <div class="col-md-6 form-group">
                <h class="text-black">Payment Receipt </h><h class="text-danger">* </h>
{{--                {{ Form::label('add_receipt', __('Payment Receipt must be required *'), ['class' => 'form-label']) }}--}}
                <div class="choose-file ">
                    <label for="file" class="form-label">
                        <input type="file" name="add_receipt" id="image" class="form-control" required >
                    </label>
{{--                    <p class="your image"></p>--}}
{{--                    <img id="blah" src="#" alt="your image" width="80" height="100" />--}}
                </div>
            </div>
