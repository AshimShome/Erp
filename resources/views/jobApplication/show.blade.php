                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <div class="col-12 text-end">
                                @if(App\Models\JobOnBoard::where('application', '=', $jobApplication->id)->exists())
                                <a href="{{ url('/job-onboard') }}" class="btn-sm btn btn-primary">
                                    View Job OnBoard</a>
                                @else
                        ...
                        <dd class="col-sm-9">
                            @if(!empty($jobApplication->resume))
                                <span class="text-sm action-btn bg-primary ms-2 ">
                                    <a href="{{ route('download.resume', [$jobApplication->id]) }}"><i class="ti ti-download text-white"></i></a>
