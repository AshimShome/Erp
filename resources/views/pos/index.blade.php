...
<head>
    ...
    <link rel="icon"
          href="{{ asset('storage/uploads/logo/') . '/' . (isset($companySettings['company_favicon']) && !empty($companySettings['company_favicon']) ? $companySettings['company_favicon']->value : 'favicon.png') }}"
                        ...
                        <div class="search-bar-left">
                            <form>
                                <div class="input-group">
                                    ...
                                    <input id="searchproduct" type="search" data-url="{{ route('search.products') }}" placeholder="{{ __('Search Product') }}" class="form-control pr-4 rounded-right">
                                </div>
                            </form>
                        </div>
                    </div>
                                                ...
                                                @endphp
                                                    <tr data-product-id="{{$id}}" id="product-id-{{$id}}">
                                                        <td class="cart-images">
                                                            <img alt="Image placeholder" src="{{ asset('storage/uploads/pro_image/'.$image_url) }}" class="card-image avatar rounded-circle-sale shadow hover-shadow-lg">
                                                        </td>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        function searchProducts(url, value,cat_id,war_id = '0') {
            console.log("Search Product URL", url);
            $.ajax({
                type: 'GET',
                url: url,
                data: {
