    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('name', __('Namedddd'),['class'=>'form-label']) }}<span class="text-danger">*</span>
...
{{--                <label for="barcode">Barcode</label>--}}
                {{ Form::label('sku', __('SKU'),['class'=>'form-label ber_test' ,'id'=>'ber_test']) }}<span class="text-danger">*</span>
                <div class="input-group">
{{--                    <input type="text" name="sku" id="skucode" class="form-control">--}}
                    {{ Form::text('sku', '', array('class' => 'form-control','required'=>'required' ,'id'=>'skucode')) }}

                    <div class="input-group-append barcode">
                        <div class="input-group-text p-3" id="sku">
...
<script>
    ...
    document.getElementById('sku').onclick = function (){
        let r = (Math.random() + 1).toString(36).substring(7);
        document.getElementById('skucode').value = "SKU"+r;
    }

    document.getElementById('ber_test').onclick = function (){
        let r = (Math.random() + 1).toString(36).substring(7);
        document.getElementById('skucode').value = "SKU"+r;
    }
