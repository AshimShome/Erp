        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card p-4 mb-4">
                    ...
                    <h6>{{Auth::user()->priceFormat($total_payment_bill)}}</h6>
{{--                <h6 class="report-text mb-0">{{Auth::user()->priceFormat($totalBill)}}</h6>--}}
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0">{{Auth::user()->priceFormat($total_payment)}}</h6>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Due')}}</h7>
                    <h6 class="report-text mb-0">{{Auth::user()->priceFormat(abs($total_due))}}</h6>
                </div>
            </div>
        </div>
        <div class="row">
                                                ...
                                                <tr>
                                                    <td class="Id">
                                                        @if(\Auth::guard('vender')->check())
                                                            <a href="{{ route('vender.bill.show',\Crypt::encrypt($bill->id)) }}" class="btn btn-outline-primary">{{ AUth::user()->billNumberFormat($bill->id) }}</a>
                                                        @else
                                                            <a href="{{ route('bill.show',\Crypt::encrypt($bill->id)) }}" class="btn btn-outline-primary">{{ AUth::user()->billNumberFormat($bill->id) }}</a>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>{{!empty($bill->payment->date)?\Auth::user()->dateFormat($bill->payment->date):''}}</td>
