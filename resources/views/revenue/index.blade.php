                ...
                <div class="card-body table-border-style mt-2">
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tbody>
                            @php
                                $revenuepath=asset('storage/uploads/revenue');
                            @endphp
...
{{--                                        @endif--}}
                                        ...
                                        @if(!empty($revenue->add_receipt))
                                            <a  class="action-btn bg-primary ms-2 btn btn-sm align-items-center" href="{{ $revenuepath . '/' . $revenue->add_receipt }}" title="{{__('Download')}}"  download="">
