...
Route::group(
    ...
    Route::get('stockadjustment/index', 'StockAdjustmentController@index')->name('stockadjustment.index');
    Route::post('stockadjustment/product/quentity', 'StockAdjustmentController@productQty');
...
Route::group(
    ...
    Route::post('/purchase-return-store', 'PurchaseReturnController@store')->name('purchase-return-store');
    Route::post('/purchase-return-details', 'PurchaseReturnController@returnDetails')->name('purchase-return-details');
//    Route::get('/delete/return/product/{id}', 'ProductServiceReturnController@destroy')->name('delete.return.product');
    Route::get('/return/product/show/pdf/{id}', 'PurchaseReturnController@productshowPDF')->name('return.product.show');
}
);
Route::get(
...
Route::get('download/job/resume/{id}', [JobApplicationController::class, 'downloadResume'])->name('download.resume')->middleware(['auth', 'XSS']);
